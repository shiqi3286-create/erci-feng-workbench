...
> 面向 **10 万 ~ 100 万字长篇** 的本地 AI 小说写作工具 · v0.5.0
...
- ✅ 系统托盘：左键切换窗口显隐，右键菜单（显示主窗口 / 检查更新 / 退出）；关闭主窗口最小化到托盘
- ✅ 手动检查更新：模板·API 页与托盘菜单均可检查 GitHub 最新版本并跳转发布页下载
- ✅ 安装向导支持简体中文（NSIS 语言选择器 + WiX zh-CN）
