/* ============================================================
 * 晴笺 · AI 小说创作台 — 示例数据层
 * 项目级数据（分卷/人物/地点/物品/伏笔/时间线）按项目存放在
 * projectData[projectId]；store.init 会把「当前项目」的集合物化
 * 到顶层同名键，页面代码直接读写顶层即可。
 * 全局数据（用户/模板/API/调用记录）保存在顶层。
 * ============================================================ */
...
window.DATA = {
  ...
  projects: [
    {
      ...
      touchedAt: "2026-09-13T07:42:00.000Z"
    },
    {
      id: "p-window",
      title: "晴天与猫",
      ...
      touchedAt: "2026-09-12T14:10:00.000Z"
    },
    {
      id: "p-sunset",
      title: "黄昏信号",
      ...
      touchedAt: "2026-09-10T10:00:00.000Z"
    }
  ],
  ...
  projectData: {
    ...
    "p-starlight": {
      volumes: [
        {
          id: "v1", title: "第一卷 · 灰烬之城", chapters: 4, done: 4,
          beats: [
            { id: "b1-1", no: "01", title: "雨夜苏醒", sum: "失忆少女凛在废墟城市醒来，体内残留未知的星辉力量，被巡夜人陆沉发现。", chars: ["凛", "陆沉"], fs: ["星辉之力"], status: "done", paras: [] },
            { id: "b1-2", no: "02", title: "灰烬教会", sum: "凛初入教会，得知星辉之力与『深渊裂隙』有关，埋下身世伏笔。", chars: ["凛", "陆沉", "阿澈"], fs: ["深渊裂隙"], status: "done", paras: [] },
            { id: "b1-3", no: "03", title: "第一次坠落", sum: "凛失控坠入裂隙边缘，被陆沉拼死救回，两人关系破冰。", chars: ["凛", "陆沉"], fs: ["失控", "约定"], status: "done", paras: [] },
            { id: "b1-4", no: "04", title: "离城的信", sum: "阿澈留下信离开，真相的一角开始松动。", chars: ["凛", "阿澈"], fs: ["阿澈的过去"], status: "done", paras: [] }
          ]
        },
        {
          id: "v2", title: "第二卷 · 星落之森", chapters: 6, done: 4,
          beats: [
            { id: "b2-1", no: "01", title: "入林", sum: "凛与陆沉进入星落之森寻找星辉本源，森林会吞噬记忆。", chars: ["凛", "陆沉"], fs: ["记忆吞噬"], status: "done", paras: [] },
            { id: "b2-2", no: "02", title: "守林人", sum: "遇到守林人阿澈的师父，得知森林中心封印着一颗『坠落的星』。", chars: ["凛", "陆沉", "老师傅"], fs: ["坠落的星"], status: "done", paras: [] },
            { id: "b2-3", no: "03", title: "记忆回廊", sum: "凛在回廊中看到零碎记忆：自己似乎来自百年前。", chars: ["凛"], fs: ["百年之谜"], status: "done", paras: [] },
            { id: "b2-4", no: "04", title: "灯火熄灭之后", sum: "森林核心的灯火熄灭，凛的星辉第一次主动回应她。本章：铺垫『星之子』身份揭露。", chars: ["凛", "陆沉", "守林人"], fs: ["星之子", "灯火"], status: "writing", ending: "凛望向森林深处，说出：『如果我是星之子，那我为什么要忘记？』", paras: [
            ...
            { id: "b2-5", no: "05", title: "银月之井", sum: "在井中见到星的倒影，获得关键道具『碎星盏』。", chars: ["凛", "陆沉"], fs: ["碎星盏"], status: "todo", paras: [] },
            { id: "b2-6", no: "06", title: "守林人的选择", sum: "老师傅牺牲自己修复封印，临别揭示凛的身世真相。", chars: ["凛", "老师傅"], fs: ["身世"], status: "todo", paras: [] }
          ]
        },
        {
          id: "v3", title: "第三卷 · 百年前的雪", chapters: 1, done: 0,
          beats: [
      ...
      foreshadows: [
        ...
        { id: "f2", text: "陆沉腰间挂着一枚熄灭的灯芯", where: "第2章 · 灰烬教会", status: "open", note: "属于上一任守夜人" },
        { id: "f3", text: "阿澈留下的信末尾画着星落之森的星图", where: "第4章 · 离城的信", status: "open", note: "第二卷呼应" },
        { id: "f4", text: "森林会吞噬记忆，但凛的记忆回廊完好", where: "第3章 · 记忆回廊", status: "open", note: "暗示凛与森林同源" },
        { id: "f5", text: "『坠落的星』封存在森林核心", where: "第2卷 · 守林人", status: "open", note: "核心主线" },
        { id: "f6", text: "灰烬教会声称凛是『灾厄』", where: "第1卷 · 第一次坠落", status: "open", note: "与『星之子』传闻冲突，伏笔回收点" }
      ],
      ...
      timeline: [
        { id: "tl1", t: "百年前", e: "星之子陨落，森林封印『坠落的星』" },
        { id: "tl2", t: "第一卷", e: "凛在灰烬之城苏醒（失忆）· 遇见陆沉 / 阿澈离开" },
        { id: "tl3", t: "第二卷", e: "入星落之森 · 灯火熄灭 · 星辉首次自主回应（当前）" },
        { id: "tl4", t: "第三卷", e: "身世揭露 · 百年前的雪（待规划）" }
      ]
    },

    "p-window": { volumes: [], characters: [], locations: [], items: [], foreshadows: [], timeline: [] },
    "p-sunset": { volumes: [], characters: [], locations: [], items: [], foreshadows: [], timeline: [] }
  },

  /* ---------- 当前项目的物化视图（store.init 覆盖） ---------- */
  volumes: [],
  characters: [],
  locations: [],
  items: [],
  ...
  /* ---------- 修改建议（示例） ---------- */
  suggestions: [
    { type: "一致性", text: "本章凛称守林人为『老伯』，但第2章两人已互报姓名，建议改为『老师傅』。" },
    { type: "节奏", text: "灯火熄灭场景已连续 3 段外部描写，建议插入一句凛的内心独白，避免信息密度断层。" },
    { type: "伏笔", text: "检测到『星之子』相关伏笔可在本段自然呼应，建议在星光回应时点一句。" }
  ],
